...
class _MyHomePageState extends State<MyHomePage> {
  ...
  @override
  Widget build(BuildContext context) {
    List<String> titles = ["৬ ফেব্রুয়ারি ১৯৭২ বাংলাদেশের স্থপতি বাঙালি জাতির জনক বঙ্গবন্ধু শেখ মুজিবুর রহমান ভারতের কলকাতা সফর",
      ...
      "১৯৭২ সালের ১৭ মার্চ ভারতের শেষ সময়ে প্রধানমন্ত্রী ইন্দিরা গান্ধী একটি দ্বিপক্ষীয় সফরে বাংলাদেশে আসেন",];
                ...
                child: Column(
                  children: <CustomListItem>[
                    CustomListItem(
                      ...
                      thumbnail: Image.asset(links[index]),
                      title: titles[index],
                    ),
                  ],
                ),
