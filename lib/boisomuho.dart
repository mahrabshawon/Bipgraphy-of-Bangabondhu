...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    // List<String> authors=["শেখ মুজিবুর রহমান","শেখ মুজিবুর রহমান","শেখ মুজিবুর রহমান","বেবী মওদুদ","শেখ হাসিনা"];
    List<String> images = ["assets/video1.png", "2", "3", "4", "5"];
    List<String> links = [
      "assets/procchod1.png",
      "assets/procchod2.png",
      "assets/procchod3.png",
      "assets/procchod4.png",
      "assets/procchod5.png"
    ];
                    ...
                    CustomListItem(
                      ...
                      thumbnail: Padding(
                        ...
                        child: GestureDetector(
                          ...
                          child: Padding(
                            padding: const EdgeInsets.only(right: 100,left: 1.0),
                            child: Image.asset(
                              links[index],
                              width: 500,
                              height: 77,
...
class _VideoDescription extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Padding(
      padding: const EdgeInsets.only(right:55,left: 0.0,top: 20,bottom: 11),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: <Widget>[
          Text(
